<template>
	<view class="lc-swiper-background-box" :class="[show?'show':'',welcome?'welcome':'']">
...
<style lang="scss" scoped>
	...
	.lc-swiper-background-box.show {
		display: block;
		transition: 0s;
	}

	.lc-swiper-background-box.welcome {
