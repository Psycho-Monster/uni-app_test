<template>
	<view>
		<view class="lc-bar-search-title-box">
...
<script>
	import _sort_data from '@/static/lcui/data/sort_vue.js';	//虚拟数据
...
<style lang="scss">
	...
	@import "../../static/lcui/style/sort_vue.scss";
