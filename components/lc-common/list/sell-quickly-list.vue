<template>
	<view class="bg-white margin radius">
		<view class="grid col-4 padding lc-sell-quickly-box">
			<view class="live-box">
			...
			<block v-for="(item,index) in ListData.list" :key="index" v-if="index < 3">
				<view class="live-box text-center lc-sell-quickly-list" @tap="listTap(item,index)">
					<image class="img" :src="item.img" mode="widthFix" />
