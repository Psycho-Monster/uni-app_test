<template>
	<view>
		...
		<!--轮播图-->
		<view class="lc-banner-swiper-box">
			...
			<!--页码-->
			<text class="cu-tag bg-grey round sm lc-page">{{bannerCur + 1}} / {{bannerList.length}}</text>
		</view>
		
		<!--限时秒杀-->
		<view class="lc-limited-seckill-box">
			<text class="text-price text-xxl">2999</text>
			<view class="text-xs lc-cost-price-num price-4">
				<view class="text-through">原价￥6999</view>
				<view>剩余79件</view>
			</view>
			<view class="text-right lc-time-right">
				<view>自营限时秒杀</view>
		...
		<!--服务-->
		<view class="margin-top bg-white lc-view-box lc-service-view-box" @tap="serviceTap">
		...
		<!--促销-->
		<view class="margin-top bg-white lc-view-box lc-promotion-view-box">
		...
		<!--选择-->
		<view class="margin-top bg-white lc-view-box lc-select-view-box">
			<view class="flex flex-wrap text-sm">
				<view class="basis-1">
		...
		<!--评论-->
		<view class="margin-top bg-white lc-comment-view-box">
		...
		<!--杂项信息-->
		<view class="margin-top bg-white lc-view-box lc-goods-info-view-box">
			<view class="lc-shop-view">
				<view class="cu-avatar lg round" style="background-image:url(/static/images/avatar/1.jpg)"/>
				<view class="text-view">
					<view class="margin-bottom-xs">小飞机店铺</view>
					<view class="text-sm text-cut">小飞机店铺，正品保障，售后无忧</view>
				</view>
			...
			<view class="lc-border-view"/>
			<view class="lc-recommend-list-box">
		...
		<!--图片详情-->
		<view class="margin-top lc-goods-details-box">
			<image src="/static/images/home/goods/goods-1.png" mode="widthFix"/>
			<image src="/static/images/home/goods/goods-2.png" mode="widthFix"/>
		</view>
		
		<!--常见问题-->
		<view class="margin-top bg-white margin-bottom lc-view-box lc-goods-help-view-box">
		...
		<!--相似推荐-->
		<view class="margin-top lc-view-box lc-recommend-list-view-box">
			...
			<view class="margin-bottom lc-goods-list-box">
		...
		<!--弹出框-->
		<view class="cu-modal bottom-modal lc-bottom-modal-box" :class="bottomModal?'show':''">
			<view class="cu-dialog bg-white">
				<!--标题-->
				<view class="text-black text-center margin-tb text-lg lc-title-bar">
					<text>{{modalTitle}}</text>
					<text class="cuIcon-close close-icon" @tap="hideModal"></text>
				</view>
				
				<!--内容区域-->
				<view class="lc-modal-content">
					
					<!--服务区域-->
					<view class="lc-view-box service" v-if="modalType=='service'">
						<view class="text-view">
							<text class="cuIcon-title text-red"/>
					...
					<!--促销区域-->
					<view class="lc-view-box promotion" v-if="modalType=='promotion'">
						<view class="text-view">
					...
					<!--选择规格-->
					<view class="lc-view-box select" v-if="modalType=='select'">
						<!--商品信息-->
						...
						<!--规格数据-->
						<view class="lc-select-btn-list-boox">
...
<script>
	...
	import _goods_data from '@/static/lcui/data/goods.js';	//虚拟数据
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/goods.scss";
</style>
