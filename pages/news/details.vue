<template>
	<view>
		...
		<!--文章标题-->
		<view class="text-black text-bold text-lg lc-title">提升幸福感的居家好物</view>
		<view class="text-gray text-sm text-right margin-lr lc-right-text">
			<text>浏览38439</text>
			<text>关注38439</text>
		</view>
		...
		<view class="lc-comment-box">
			<view class="lc-view-box">
				<view class="flex flex-wrap">
					...
					<view class="basis-9">
						<view class="text-black">小飞机</view>
