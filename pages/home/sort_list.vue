<template>
	<view>
		...
		<!--轮播图-->
		<view class="bg-white lc-swiper-box">
		...
		<!--投资-->
		<view class="bg-white lc-invest-title-box">
			<view class="text-box">
		...
		<!--圆图标导航-->
		<view class="bg-white lc-grid-round-box">
		...
		<!--限时秒杀-->
		<view class="bg-white lc-seckill-list-view-box">
		...
		<!--宫格活动-->
		<view class="lc-gird-hot-goods-box">
		...
		<!--商品列表-->
		<view class="bg-white margin-top padding-bottom-sm padding-top-sm lc-goods-list-view-box">
		...
		<!--加号按钮-->
		<view class="lc-footer-fixed lc-add-btn-view-box">
...
<script>
	import barSearchTitle from '@/components/lc-common/basics/bar-search-title';
	import goodsSortList from '@/components/lc-common/list/goods-sort-list';

	import _sort_list_data from '@/static/lcui/data/sort_list.js';	//虚拟数据
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/sort_list.scss";
</style>
