<template>
	<view>
		...
		<!--状态图标-->
		<view class="bg-white padding solid-top text-center lc-status-img-view" v-if="basics == 4 && !cancel">
			<view class="are-img-view" @tap="cancel = true">
				<image class="are-img" src="/static/lcui/img/are.png" mode="widthFix"/>
			</view>
		...
		<view class="bg-white padding solid-top text-center lc-status-img-view" v-if="basics == 4 && cancel">
			<view class="are-img-view" @tap="cancel = false">
				<image class="are-img" src="/static/lcui/img/arg.png" mode="widthFix"/>
			</view>
			<view class="text-sm text-black">订单已取消</view>
		</view>
		
		<!--广告区域-->
		<view class="bg-white lc-card-box" v-if="basics == 0">
			<view class="lc-card-view lc-goods-ad-view">
		...
		<!--物流信息-->
		<view class="bg-white lc-card-box" v-if="basics != 0">
			<view class="lc-card-view lc-address-view">
		...
		<!--商品信息-->
		<view class="bg-white lc-card-box">
			<view class="lc-card-view lc-shop-view">
				<view class="shop-info-view">
					<view class="cu-avatar round sm" :style="[{backgroundImage:'url('+ avatar +')'}]"/>
					<view class="text-black text-bold text-lg title-view">小飞机科技运营部</view>
				</view>
				...
				<view class="lc-foot-view">
					<view class="left-view">
						<image class="af5-img" src="/static/lcui/img/af5.png" mode="widthFix"/>
		...
		<!--商品金额-->
		<view class="bg-white lc-card-box">
			<view class="lc-card-view lc-price-view">
		...
		<!--订单信息-->
		<view class="bg-white lc-card-box">
			<view class="lc-card-view lc-order-view">
		...
		<view class="bg-white lc-card-hight-box"/>
		
		<!--为您推荐-->
		<view class="lc-title-view">
			<view class="flex flex-wrap">
				<view class="basis-sm text-right">
					<image class="img-anc" src="/static/lcui/img/anc.png" mode="widthFix"/>
				</view>
		...
		<!--推荐列表-->
		<view class="lc-recommend-goods-list-view">
			<view class="flex flex-wrap">
		...
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="basics == 0">
		...
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="basics == 1">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
			<button class="cu-btn bg-red">提醒发货</button>
		</view>
		
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="basics == 2">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
		</view>
		
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="basics == 3">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
			<button class="cu-btn bg-red" @tap="confirmReceipt">确认收货</button>
		</view>
		
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="basics == 4">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/order-details.scss";
</style>
