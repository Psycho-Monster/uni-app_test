<template>
	<view class="bg-white margin radius">
		...
		<view class="grid col-3 padding-bottom-sm lc-identify-box">
			<view class="padding-xs live-box" v-for="(item,index) in list_data" :key="index" :data-index='index' @tap="listTap(item,index)">
