<template>
	<view>
		...
		<!--足迹的tab-->
		<view class="bg-white lc-nav-view">
		...
		<checkbox-group class="block" @change="checkboxChange">
			<!--商品列表-->
			<view class="bg-white lc-goods-list-view" :class="goods_checked?'checked':''">
				<view class="lc-checkbox-view">
					<checkbox class='round red lc-checked' :class="checkbox_list[0].checked?'checked':''"
					:checked="checkbox_list[0].checked?true:false" :value="checkbox_list[0].id + ''"/>
					<view class="text-black">今天</view>
				</view>
				<view class="lc-goods-list-box">
					<checkbox class='round red lc-checked' :class="checkbox_list[1].checked?'checked':''"
				...
				<view class="lc-goods-list-box">
					<checkbox class='round red lc-checked' :class="checkbox_list[2].checked?'checked':''"
			...
			<view class="bg-white lc-goods-list-view" :class="goods_checked?'checked':''"> 
				<view class="lc-checkbox-view">
					<checkbox class='round red lc-checked' :class="checkbox_list[3].checked?'checked':''"
					:checked="checkbox_list[3].checked?true:false" :value="checkbox_list[3].id + ''"/>
					<view class="text-black">2020-04-01</view>
				</view>
				<view class="lc-goods-list-box lc-lower-shelf">
					<checkbox class='round red lc-checked' :class="checkbox_list[4].checked?'checked':''"
				...
				<view class="lc-goods-list-box lc-lower-shelf">
					<checkbox class='round red lc-checked' :class="checkbox_list[5].checked?'checked':''"
		...
		<!--底部操作-->
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom" v-if="goods_checked">
			<view class="cu-bar padding-lr">
				<view class="checked-view" @tap="tapChecked"> 
					<checkbox class='round red sm lc-checked' :class="checkbox_all?'checked':''" :checked="checkbox_all"/>
		...
		<!-- #ifdef MP -->
			<!--编辑-->
			<view class="lc-add-btn-view-box" @tap="rightTap">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/footmark.scss";
</style>
