<template>
	<view class="lc-news-box" :class="show?'show':''">
		<!--标题栏-->
		...
		<!--关注-->
		<view class="cu-bar bg-white lc-follow-box">
		...
		<!--宫格菜单-->
		<view class="margin-bottom lc-grid-menu">
		...
		<!--消息列表-->
		<view class="bg-white lc-news-list-box">
			<view class="margin-bottom cu-list menu-avatar">
				...
				<view class="cu-item goods" :class="modalName=='move-box-'+ 2?'move-cur':''" @touchstart="ListTouchStart" @touchmove="ListTouchMove"
				 @touchend="ListTouchEnd" :data-target="'move-box-' + 2" @tap="tapNews(2)">
					...
					<view class="content">
						<view class="text-black">
							<text class="margin-right-xs">小飞机22</text>
