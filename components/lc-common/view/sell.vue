<template>
	<view class="lc-sell-box" :class="show?'show':''">
		
		<view class="lc-bar-view-box">
			<!--小程序端的标题-->
			<!-- #ifdef MP -->
			<view class="text-center text-black lc-small-routine-title">卖小飞机</view>
			<!-- #endif -->
			
			<!--标题栏-->
			<view class="text-gray lc-bar-box">
		...
		<!--占位的-->
		<view class="lc-seat-height"></view>
...
<script>
	import typeList from '@/components/lc-common/list/type-list';
	
	import _sell_data from '@/static/lcui/data/sell.js';	//虚拟数据
