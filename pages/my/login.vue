<template>
	<view>
		...
		<!--协议-->
		<view class="lc-agreement-checked-view">
		...
		<!--底部说明-->
		<view class="text-sm text-gray lc-foot-ad-view">腾讯投资-更专业的闲置二手交易平台</view>
