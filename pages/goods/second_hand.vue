<template>
	<view>
		...
		<view class="bg-white lc-scroll-tab-view" v-if="!barShow">
		...
		<!--Tab栏占位-->
		<view class="lc-scroll-height-view" v-if="!barShow"/>
		
		<!--商品简介-->
		<view class="bg-white padding lc-goods-synopsis-view">
			<view class="user-view">
				<view class="cu-avatar sm round" style="background-image:url(/static/images/avatar/1.jpg)"/>
				<view class="text-black text-name">小飞机11</view>
			...
			<view class="text-sm margin-top-sm lc-map-view">
		...
		<!--服务-->
		<view class="margin-top padding bg-white lc-service-view-box">
		...
		<!--商品详情-->
		<view class="margin-top padding bg-white lc-details-view-box">
			...
			<view class="text-black lc-text-content-view">iphoneX,美版256G,原装正品，无拆修，配件齐全，功能正常使用</view>
			
			<view class="lc-img-box">
			...
			<view class="bg-white lc-steps-view">
		...
		<!--关于卖家-->
		<view class="margin-top bg-white lc-selll-user-view-box">
			...
			<view class="padding lc-grid-tab-view">
			...
			<!-- #ifndef MP-TOUTIAO -->
			<view class="lc-goods-swiper-view">
		...
		<!--互动-->
		<view class="margin-top padding bg-white lc-interaction-view-box">
			...
			<view class="lc-interaction-view" v-else>
				...
				<view class="lc-interaction-list-view">
					...
					<view class="list-itme">
						...
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">小飞机33</text>
					...
					<view class="list-itme">
						...
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">小飞机444</text>
			...
			<view class="lc-tag-text-view-box">
				<view class="text-cut">
		...
		<!--您推荐同型号已验机商品-->
		<view class="margin-top padding bg-white lc-recommend-goods-box">
			<view class="text-black">为您推荐同型号已验机商品</view>
			<view class="margin-top lc-goods-info-box">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/second_hand.scss";
</style>
