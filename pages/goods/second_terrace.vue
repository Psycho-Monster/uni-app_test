	...
	<view>
		...
		<view class="bg-white padding lc-goods-synopsis-view">
			<view class="user-view">
				...
				<view class="text-black text-name">小飞机</view>
		...
		<view class="margin-top padding bg-white lc-details-view-box">
			...
			<view class="bg-gray padding radius lc-bubble-view">
		...
		<view class="margin-top padding bg-white lc-interaction-view-box">
			...
			<view class="text-center lc-interaction-view">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/second_terrace.scss";
</style>
