<template>
	<view>
		...
		<!--商品信息-->
		<view class="bg-white lc-goods-details-box pay_status">
			...
			<!--提示-->
			<view class="lc-goods-tip-view" :class="tipShow?'show':''">
			...
			<!--按钮-->
			<view class="lc-goods-info-btn-view" @tap="tipShowTap">
		...
		<!--聊天框-->
		<view class="lc-chat-scroll-view" :class="chatShow?'tools':''" @tap="setToolsHidden">
		...
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom">
			<!--操作区域-->
			<view class="cu-bar input lc-foot-bar-input-tools">
				<view class="action">
			...
			<!--快捷输入-->
			<view class="lc-speedy-view" :class="speedyShow?'show':''">
			...
			<!--表情栏-->
			<view class="lc-emoji-view" :class="emojiShow?'show':''">
					...
					<swiper class="emoji-swiper" :current="emoji_swiper" indicator-dots @change="emoji_change">
						<swiper-item>
							<view class="cu-list grid no-border">
								...
								<image class="del_btn" src="/static/lcui/img/aa2.png" mode="widthFix" @tap="emojiDelTap"/>
							</view>
						</swiper-item>
						<swiper-item>
							<view class="cu-list grid no-border">
			...
			<!--更多工具-->
			<view class="lc-tools-view" :class="toolsShow?'show':''">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/chat.scss";
</style>
