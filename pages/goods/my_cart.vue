<template>
	<view>
		...
		<view class="bg-white lc-cart-list-view">
			<checkbox-group class="block" @change="CheckboxChange">
				<block v-for="(item,index) in goodsList" :key="item.id">
					<view class="padding lc-checkbox-title-view">
						<checkbox class='round red sm lc-checked' :class="item.checked?'checked':''"
					...
					<block v-for="(items,indexs) in item.goods" :key="items.id">
						<view class="light goods-list-item-view">
							<checkbox class='round red sm lc-checked' :class="items.checked?'checked':''" 
							...
							<view class="goods-info-view">
								...
								<view class="goods-price-view">
									...
									<view class="step-btn-view">
										<button class="lc-btn text-gray">-</button>
										<input class="lc-input" type='number' :value="items.num"></input>
										<button class="lc-btn">+</button>
									</view>
								</view>
							</view>
						</view>
		...
		<view class="bg-white lc-footer-fixed lc-foot-padding-bottom">
			<view class="cu-bar padding-lr">
				<view class="checked-view" @tap="tapChecked"> 
					<checkbox class='round red sm lc-checked' :class="checkAll?'checked':''" :checked="checkAll"></checkbox>
...
<script>
	...
	import _my_cart_data from '@/static/lcui/data/my_cart.js';	//虚拟数据
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/lcui/style/my_cart.scss";
</style>
