<template>
	<view class="margin-bottom lc-goods-list-box" :class="show?'show':''">
								...
								<view class="flex">
									<view class="flex-sub">
										<view class="flex flex-wrap user-info">
											...
											<image class="v-icon" src="/static/lcui/img/v.png" lazy-load mode="widthFix" v-if="item.v"/>
										</view>
									</view>
					...
					<view class="bg-white margin-bottom-sm list-radius padding-sm recommend-list-box" v-if="item.type=='recommend'">
						<view class="flex flex-wrap">
							<view class="basis-xs text-right">
								<image class="img-aat" src="/static/lcui/img/aat.png" lazy-load mode="widthFix"/>
							</view>
