<template>
	<view class="lc-find-box" :class="show?'show':''">
		<!--分类标题栏-->
		<view class="bg-white lc-title-tab-box">
			
			<!--小程序端的标题-->
			<!-- #ifdef MP -->
			<view class="text-center text-black lc-small-routine-title">发现</view>
			<!-- #endif -->
		...
		<!--占位的-->
		<view class="lc-seat-height"/>
		
		<!--中间内容区域-->
		<view class="lc-view-content" v-if="TabCur == 0">
		...
		<!--中间内容区域-->
		<view class="lc-view-content" v-if="TabCur == 1">
...
<script>
	import trendsList from '@/components/lc-common/list/trends-list';
	import hotTopicList from '@/components/lc-common/list/hot-topic-list';
	import recommendScrollList from '@/components/lc-common/list/recommend-scroll-list';
	import topicGridList from '@/components/lc-common/list/topic-grid-list';
	import topicCardList from '@/components/lc-common/list/topic-card-list';
	
	//======================================================================
	import _find_data from '@/static/lcui/data/find.js';	//虚拟数据
