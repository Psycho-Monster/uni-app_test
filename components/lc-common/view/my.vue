<template>
	<view class="lc-my-box" :class="show?'show':''">
		<view class="bg-gradual-red lc-head-box">
			<!--标题栏-->
			<!--小程序端不显示-->
			<!-- #ifndef MP -->
					...
					<view class="cu-item">
						...
						<view class="content text-xl">
							<view class="text-white">
								<text class="margin-right">小飞机</text>
			...
			<!--用户数据-->
			<view class="lc-user-info-num-box">
			...
			<!--用户提示-->
			<view class="text-sm lc-user-info-tip-box" v-if="!login" @tap="realNameTap">
		...
		<view class="lc-view-content">
			<!--用户数据-->
			<view class="padding-xs bg-white lc-user-info-order-box">
			...
			<!--天天有钱-->
			<view class="padding-xs bg-white margin-top lc-user-info-money-box">
			...
			<!--推荐工具-->
			<view class="padding-xs bg-white margin-top lc-user-info-tools-box">
...
<script>
	...
	import _my_data from '@/static/lcui/data/my.js';	//虚拟数据
