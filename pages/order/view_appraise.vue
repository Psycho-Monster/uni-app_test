<template>
	<view>
		...
		<view class="bg-white lc-goods-details-box">
			...
			<view class="text-gray text-sm text-cut lc-goods-tip-view">您购买的商品信息仅对您本人可见,不会对他人展示。</view>
		</view>
		
		<!--间距-->
		<view class="lc-hight-view"/>
		
		<!--评价内容-->
		<view class="lc-appraise-view">
...
<style lang="scss">
	...
	.lc-appraise-view {
		...
		margin: 27.27rpx 27.27rpx 27.27rpx 136.36rpx;
