<template>
	<view>
		...
		<view class="bg-white solid-top lc-head-box">
			...
			<progress class="lc-progress-radius" percent="100" active stroke-width="10" activeColor="#f37b1d"/>
		</view>
