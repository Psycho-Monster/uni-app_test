<template>
	<view>
		...
		<!--列表-->
		<view class="bg-white lc-address-card-view">
			<view class="flex text-black text-lg" @tap="editAddressTap">
				<view class="flex-sub text-left">小飞机</view>
				<view class="flex-sub text-right">138****8000</view>
			</view>
			<view class="margin-tb-sm text-gray" @tap="editAddressTap">
				重庆是 渝北区 网络购买专用虚拟地址
			</view>
			<view class="lc-line-view"/>
			<view class="lc-right-view">
		...
		<view class="bg-white lc-address-card-view">
			<view class="flex text-black text-lg" @tap="editAddressTap">
				<view class="flex-sub text-left">小飞机1</view>
				<view class="flex-sub text-right">138****8000</view>
			</view>
			<view class="margin-tb-sm text-gray" @tap="editAddressTap">
				重庆是 渝北区 网络购买专用虚拟地址1
